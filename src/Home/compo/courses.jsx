...
const Courses = () => {
  ...
  const filteredCourses = useMemo(() => {
    ...
    if (activeFilter === "all") {
      // Shuffle and get random courses for 'all' filter
      filtered = shuffleArray(enhancedCourses);
    ...
    // Limit to 8 courses for home page display
  ...
  return (
    <section className="bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4">
        ...
        {/* Search Bar - Regular input field from the first file */}
        ...
        <div>
          ...
          <div
            ...
            key={activeFilter + searchQuery} // Re-trigger animation when filter or search changes
          >
          ...
          {/* View All Courses Button - Only show when not searching */}
          {!searchQuery && (
            <div className="flex mx-auto justify-center items-cen">
              <button
                onClick={(e) => handleClickie(e, 0, "/courses")}
                className="inline-flex gap-2 mt-4 mx-auto justify-center items-center px-6 py-3 rounded-lg bg-sec2 hover:bg-primary font-medium transition-all text-white duration-200 hover:shadow-md"
              >
                {loading === 0 ? (
                  <>
                    <ImSpinner className="animate-spin" size={14} />
