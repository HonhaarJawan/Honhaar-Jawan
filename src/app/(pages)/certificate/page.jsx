...
export function generateMetadata() {
  return {
    title: {
      default: `Certificate Verification | ${SiteDetails.programName}`,
    },
    description:
...
const CertificateContent = () => {
  return (
    <>
      ...
      <PageInfo
        title="Official Honhaar Jawan Certificate Portal"
        subtitle="Government-Recognized Skill Certifications"
        description="Validate your professional achievements and showcase your skills with our officially recognized government certificates. Request and track your certificates through our secure portal."
      />
      ...
      fallback={
        <div className="min-h-screen bg-gray-100 flex items-center justify-center">
          <div className="flex items-center gap-2 text-gray-700">
            ...
            <span>Loading Certificate Portal...</span>
          </div>
        </div>
      }
    >
