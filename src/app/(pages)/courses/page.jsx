// Courses.js - Government Style Redesign
...
export function generateMetadata() {
  return {
    title: {
      default: `All Courses | ${SiteDetails.programName}`,
    },
    description:
...
const Courses = () => {
  return (
    <div className="min-h-screen">
      ...
      <PageInfo
        title="Honhaar Jawan - All Courses"
        subtitle="Comprehensive Learning Programs for Skill Development"
        description="Browse our official catalog of certified courses designed to enhance your technical skills and career prospects. All programs are accredited and recognized nationally."
      />
