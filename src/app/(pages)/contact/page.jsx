...
export function generateMetadata() {
  return {
    title: {
      default: `Contact Us | ${SiteDetails.programName}`,
    },
    description:
...
const Contact = () => {
  return (
    <>
      ...
      <PageInfo
        title="Contact Honhaar Support & Inquiries"
        subtitle="Official Government Support Portal"
        description="Have a question, feedback, or need support? Reach out to us through the form or contact details below. Our government support team is ready to assist you."
      />
