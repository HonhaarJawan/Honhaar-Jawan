...
export function generateMetadata() {
  return {
    title: {
      default: `News & Events | ${SiteDetails.programName}`,
    },
    description:
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50">
      ...
      <PageInfo
        ...
        description="Discover the latest news, updates, and upcoming events from Honhaar Jawan. Stay informed about new course launches, industry insights, and important announcements."
      />
      <Client />
